export function bulkJDTemplate(candidateName, jdTitle, companyName, applyUrl) {
  return `
    <div style="font-family:Arial,sans-serif;max-width:600px;margin:auto;padding:24px;background:#f9f9f9;border-radius:8px;">
      ...
      <a href="https://recruterai.in/CandidateLogin" style="display:inline-block;padding:12px 24px;background:#007bff;color:#fff;text-decoration:none;border-radius:4px;font-weight:bold;">Candidate Login</a>
